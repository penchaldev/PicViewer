...
public class CHWActivityIndicator: NSObject {
    ...
    fileprivate static let shared: CHWActivityIndicator = {
        let instance = CHWActivityIndicator()
    ...
    fileprivate func configureActivityIndicator(withStatusMessage message: String, isUserInteractionEnabled userInteractionStatus: Bool) {
        ...
        if spinnerContainerView != nil {
            ...
            CHWActivityIndicatorStyle.createSpinner(in: viewLayer, size: animationRectsize, color: spinnerColor, style: activityIndicatorStyle)
        }
